...
import { ArrowRight, Download, Github, Linkedin, Mail, Twitter, MessageCircle } from 'lucide-react';
...
const Home = () => {
  ...
  const socialLinks = [
    ...
    { name: 'Telegram', icon: <MessageCircle size={24} />, url: profileData.socialLinks.telegram || '#' },
